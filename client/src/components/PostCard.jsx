          ...
          <React.Fragment>
            ...
            {post.file.type === "video" && (
              <video
                src={post.file.url}
                controls
                className=" mt-2 rounded-lg w-full h-auto max-h-[300px]"
              />
            )}
            ...
            {post.file.type === "text" && (
              <a
                ...
                className="inline-block mt-2 rounded-lg p-2 bg-gray-200 text-gray-800"
              >
                <FaFile className="mr-2" size={32} />
              </a>
            )}
            {post.file.type === "application" && (
              <a
                href={post.file.url}
                target="_blank"
                rel="noopener noreferrer"
